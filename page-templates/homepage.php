...
<div class="wrapper home-page" id="full-width-page-wrapper">
				...
				<div class="row">
					<div class="col-md-2">
						...
						<div class="sm-blue-dark rellax"
							data-rellax-speed="2"
							style="transform: rotate(45deg); margin-top:200px; margin-left:150px">
						</div>
					</div>
					...
					<div class="col-md-2">
						<div class="sm-grey rellax"
							data-rellax-speed="3"
							style="transform: rotate(45deg); margin-top:400px; margin-left:-30px">
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 wow fadeIn" data-wow-offset="150">
					<h2 class="section-title text-center"><?php the_field('needs_meets'); ?></h2>
					<p class="section-lead lead text-center"><?php the_field('needs_meets_text'); ?></p>
				</div>
			</div>
			<div class="row align-items-center pt-3 pb-5 my-3 wow fadeIn" data-wow-offset="230">
				...
				<div class="col-md-4">
					<div class="content-box d-flex align-items-center">
						...
						<div class="content">
							<h4><?php the_field('need_meets_icon_title_1') ?></h4>
							<p><?php the_field('need_meets_icon_text_1') ?></p>
						</div>
					</div>
					...
					<div class="content-box d-flex align-items-center">
						...
						<div class="content">
							<h4><?php the_field('need_meets_icon_title_2') ?></h4>
							<p><?php the_field('need_meets_icon_text_2') ?></p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="content-box d-flex align-items-center">
						...
						<div class="content">
							<h4><?php the_field('need_meets_icon_title_3') ?></h4>
							<p><?php the_field('need_meets_icon_text_3') ?></p>
						</div>
					</div>
					...
					<div class="content-box d-flex align-items-center">
						...
						<div class="content">
							<h4><?php the_field('need_meets_icon_title_4') ?></h4>
							<p><?php the_field('need_meets_icon_text_4') ?></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-5">
					<button class="btn-lg btn-primary btn-block waves-effect waves-blue btn" href="<?php echo esc_url( home_url('/') ); ?>"><?php esc_html_e('Get Involved', 'understrap') ?></button>
				</div>
			</div>
				...
				<div class="col-md-4 wow fadeInLeft" data-wow-duration="1.5s" data-wow-offset="200">
					<div class="inner-box">
						...
						<div class="content-box">
							<h4><?php echo esc_html_e('Alpha Square', 'understrap') ?></h4>
	...
	<section id="news" >
		<div class="container">
			...
			<div class="row my-5">
				<div class="col-md-5">
					<?php $featured = new WP_Query( array( 'post_type' => 'post', 'posts_per_page' => 1, 'category_name' => 'featured', 'post_status' => 'publish', 'orderby' => 'date', 'order' => 'DESC' ) );
					while ( $featured->have_posts() ) : $featured->the_post(); ?>
						<div class="post-featured wow fadeIn" data-wow-offset="200" data-wow-duration="2s">

							<?php the_post_thumbnail('featured-thumb', ['class' => 'img-fluid d-block mx-auto']); ?>
							<div class="overlay-box text-center">
								<h4><?php the_title(); ?></h4>
								<p><span class="meta-date"><?php the_time( get_option('date_format') ); ?></span>	|	<?php the_category('<span>|</span> '); ?></p>
								<button class="btn btn-md btn-primary btn-block" href="<?php echo get_permalink() ?>"><?php esc_html_e('Read More', 'understrap') ?></button>
							</div>
						</div>
					<?php endwhile; ?>
					<?php wp_reset_query(); ?>
				...
				<div class="col-md-7">
					<?php $loop = new WP_Query( array( 'post_type' => 'post', 'posts_per_page' => 3, 'category_name' => '', 'post_status' => 'publish', 'orderby' => 'date', 'order' => 'DESC' ) );
					while ( $loop->have_posts() ) : $loop->the_post(); ?>

						<article id="post-<?php the_ID(); ?>" class="post-latest d-flex wow fadeInRight" data-wow-offset="200">
							<?php if(has_post_thumbnail()) : ?>
								<div class="image-thumb">
									<a href="<?php echo get_permalink() ?>"><?php the_post_thumbnail('post-thumb', ['class' => 'img-fluid d-block mx-auto']); ?></a>
								</div>
							<?php endif; ?>
							...
							<div class="post-article">
								...
								<p><span class="meta-date"><?php the_time( get_option('date_format') ); ?></span>	|	<?php the_category('<span>|</span> '); ?></p>
								<a href="<?php echo get_permalink() ?>"><?php _e( 'Read More »', 'understrap' ); ?></a>
							</div>
						</article>
	...
	<section id="counters" class="d-none d-md-block">
		<div class="container-fluid">
			<div class="row">
				<div class="col-12">
	...
	<section id="sponsors">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<h3 class="text-center section-title wow fadeIn" date-wow-offset="200">Our Sponsors</h3>
					<p class="section-lead lead text-center wow fadeIn" data-wow-duration="2s" data-wow-offset="200"><?php echo esc_html_e('Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore. magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip.', 'understrap'); ?></p>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-md-6 py-5 wow fadeInRight">
						<div class="content">
							...
							<div class="row pt-4">
								<div class="col-lg-6">
									<button class="btn btn-md btn-secondary btn-block waves-effect waves-dark" href="<?php echo esc_url( home_url('/') ); ?>"><?php esc_html_e('Learn More', 'understrap') ?></button>
								</div>
							</div>
						</div>
				</div>
...
<section id="donate">
	<div class="container">
		<div class="row align-items-center">
			...
			<div class="col-md-3">
				<button class="btn btn-lg btn-primary btn-block waves-effect waves-blue wow fadeIn" data-wow-duration="2s" data-wow-offset="200" href="<?php echo esc_url( home_url('/') ); ?>"><?php esc_html_e('Donate Today', 'understrap') ?></button>
			</div>
		</div>
	</div>
</section>
